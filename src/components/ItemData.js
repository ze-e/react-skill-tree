    ...
    <li className = {`item-data ${my.color}`}>
      ...
      {editing ?
        ...
        <form onSubmit={toggleEdit}>
          ...
          {DATA[my.group-1] && DATA[my.group-1].length > 0 &&
            <>
            <br />
      ...
      :
        //done editing
        <>
        <h5 className='item-data__name' onClick={toggleEdit}>{my.name}</h5>
        <button className="item-data__edit" type="button" onClick={toggleEdit}>Edit</button>
